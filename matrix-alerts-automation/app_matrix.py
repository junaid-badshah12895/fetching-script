...
async def main():
    try:
        ...
        with open("customer_paid_channel_alerts.json", "w") as f:
            json.dump(customer_candidate_matrix_alerts, f, indent=4)
        with open("notell_paid_channel_alerts.json", "w") as f:
